namespace TeduShop.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TeduShop.Data.BackupDbContext>
    {
        ...
        protected override void Seed(TeduShop.Data.BackupDbContext context)
        {
        ...
        private void CreateFunction(BackupDbContext context)
        {
        ...
        private void CreateConfigTitle(BackupDbContext context)
        {
        ...
        private void CreateUser(BackupDbContext context)
        {
            var manager = new UserManager<AppUser>(new UserStore<AppUser>(new BackupDbContext()));
            if (manager.Users.Count() == 0)
            {
                var roleManager = new RoleManager<AppRole>(new RoleStore<AppRole>(new BackupDbContext()));
        ...
        private void CreateProductCategorySample(TeduShop.Data.BackupDbContext context)
        {
        ...
        private void CreateFooter(BackupDbContext context)
        {
        ...
        private void CreateSlide(BackupDbContext context)
        {
        ...
        private void CreatePage(BackupDbContext context)
        {
        ...
        private void CreateContactDetail(BackupDbContext context)
        {
